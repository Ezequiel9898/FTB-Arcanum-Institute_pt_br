const dialogues = {
    ...
    Student: [
        "Parece que o diretor Tazz na verdade se chama Leroy, porque uma vez entrei correndo no escritório dele gritando 'Leroy Jenkins' por causa de um desafio... foi assim que descobri que eles te fazem ler poesia goblínica quando você está de castigo.",
        'Você tem praticado seus feitiços ultimamente?',
        "Mal posso esperar pela nossa próxima aula de Poções!",
        "Você ouviu falar do novo encantamento que vamos aprender?",
        'Você viu a incrível habilidade com a varinha que o Professor Saereth demonstrou hoje?',
        "Estou com muita dificuldade em Transfiguração. Você poderia me dar algumas dicas para melhorar?",
        'O que você acha do novo professor de Defesa Contra as Artes das Trevas?',
        'Que tal se juntar a mim para praticar alguns feitiços depois da aula?',
        "Ouvi dizer que vai ter uma exposição de criaturas mágicas na biblioteca na próxima semana.",
        'Você ficou sabendo do estudante que sem querer se transformou em um gato durante a aula de Encantamentos?',
        'Você poderia me dar uma mão para decifrar esse enigma do livro de Encantamentos?',
        "Estou super empolgado para a próxima partida de Voo de Vassouras!",
        'Você viu as novas vassouras que acabaram de ser lançadas?',
        "Não consigo acreditar o quão desafiadora foi a prova de Artes das Trevas!",
        'Qual é a sua opinião sobre o novo livro de Runas Antigas na biblioteca?',
        'Você já tentou preparar uma poção por conta própria?',
        'Você conhece algum feitiço defensivo eficaz para duelos?',
        'O que você acha do novo professor de Adivinhação?',
        "Estou pensando em me inscrever para o time de Xadrez Mágico da escola. Você gostaria de se juntar a mim?",
        'Você ouviu falar do suposto corredor secreto que leva até a Árvore Proibida?',
    ...
    'Waypoint Zora': [
        'Este Waypoint mostrará os caminhos ao redor do Instituto Arcanum! Há muitos por aqui. Alguns até possuem §bLuminizers§r para ajudar você a se mover mais rapidamente!',
    ],
}
